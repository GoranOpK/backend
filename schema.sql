...
CREATE TABLE `reservations` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `drop_off_time_slot_id` bigint unsigned NOT NULL,
  `pick_up_time_slot_id` bigint unsigned NOT NULL,
...
CREATE TABLE `vehicle_types` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `description_vehicle` text COLLATE utf8mb4_unicode_ci,
...
-- Dump completed on 2025-05-29 22:32:18
